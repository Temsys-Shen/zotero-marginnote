...
var Si18n = (function () {
  ...
  var zhCNTranslations = {
    ...
    "onboarding_step_4": "在选中卡片工作区，你可将文献卡片的子卡片导出到Zotero，便于后续整理与复用。",
    "onboarding_step_5": "准备开始前，请前往设置页完成API配置，配置完成后即可使用完整功能。",
    "onboarding_prev": "上一页",
    "onboarding_next": "下一页",
  ...
  var enTranslations = {
    ...
    "onboarding_step_4": "In Selected Cards, you can export child cards of a literature card to Zotero for later organization and reuse.",
    "onboarding_step_5": "Before you begin, go to Settings and complete API configuration to unlock full features.",
